...
const MappingEntry scope_50_entries[1] = {
    /* 0 */ { MAP_STRONG_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_43_entries[5], isActive__3_SSM_TR_SM1_SSM_TR_Retracted_Deployed_1_Retracted_SM1, NULL, 1, 0 }
};
...
const MappingEntry scope_49_entries[2] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_43_entries[5], isActive__3_SSM_TR_SM1_SSM_TR_Retracted_Deployed_1_Retracted_SM1, &scope_50, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(kcg_bool), offsetof(outC_Bridge, _L1_Retracted_SM1), &_Type_kcg_bool_Utils, &scope_43_entries[0], isActive__2_SSM_ST_SM1_SSM_st_Retracted_SM1, NULL, 1, 1 }
};
...
const MappingEntry scope_48_entries[1] = {
    /* 0 */ { MAP_STRONG_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_43_entries[5], isActive__3_SSM_TR_SM1_SSM_TR_Deployed_Retracted_1_Deployed_SM1, NULL, 1, 0 }
};
...
const MappingEntry scope_47_entries[2] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_43_entries[5], isActive__3_SSM_TR_SM1_SSM_TR_Deployed_Retracted_1_Deployed_SM1, &scope_48, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_bool), offsetof(outC_Bridge, _L4_Deployed_SM1), &_Type_kcg_bool_Utils, &scope_43_entries[0], isActive__2_SSM_ST_SM1_SSM_st_Deployed_SM1, NULL, 1, 1 }
};
...
const MappingEntry scope_46_entries[1] = {
    /* 0 */ { MAP_STRONG_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_43_entries[5], isActive__3_SSM_TR_SM1_SSM_TR_ToMove_Retracted_2_ToMove_SM1, NULL, 1, 0 }
};
...
const MappingEntry scope_45_entries[1] = {
    /* 0 */ { MAP_STRONG_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_43_entries[5], isActive__3_SSM_TR_SM1_SSM_TR_ToMove_Deployed_1_ToMove_SM1, NULL, 1, 0 }
};
...
const MappingEntry scope_44_entries[3] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_43_entries[5], isActive__3_SSM_TR_SM1_SSM_TR_ToMove_Deployed_1_ToMove_SM1, &scope_45, 1, 0 },
    /* 1 */ { MAP_FORK, "<2", NULL, 0, 0, NULL, &scope_43_entries[5], isActive__3_SSM_TR_SM1_SSM_TR_ToMove_Retracted_2_ToMove_SM1, &scope_46, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), offsetof(outC_Bridge, _L5_ToMove_SM1), &_Type_kcg_bool_Utils, &scope_43_entries[0], isActive__2_SSM_ST_SM1__7_SSM_st_ToMove_SM1, NULL, 1, 2 }
};
...
const MappingEntry scope_43_entries[10] = {
    ...
    /* 7 */ { MAP_STATE, "ToMove:", NULL, 0, 0, NULL, &scope_43_entries[0], isActive__2_SSM_ST_SM1__7_SSM_st_ToMove_SM1, &scope_44, 1, 7 },
    /* 8 */ { MAP_STATE, "Deployed:", NULL, 0, 0, NULL, &scope_43_entries[0], isActive__2_SSM_ST_SM1_SSM_st_Deployed_SM1, &scope_47, 1, 8 },
    /* 9 */ { MAP_STATE, "Retracted:", NULL, 0, 0, NULL, &scope_43_entries[0], isActive__2_SSM_ST_SM1_SSM_st_Retracted_SM1, &scope_49, 1, 9 }
};
...
const MappingEntry scope_42_entries[2] = {
    ...
    /* 1 */ { MAP_AUTOMATON, "SM1:", NULL, 0, 0, NULL, NULL, NULL, &scope_43, 1, 1 }
};
...
const MappingEntry scope_39_entries[7] = {
    ...
    /* 2 */ { MAP_LOCAL, "_L1", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L1_Bridge_SM1, &_Type_kcg_bool_Utils, &scope_3_entries[0], isActive_SSM_ST_SM1_SSM_st_Bridge_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L3_Bridge_SM1, &_Type_kcg_bool_Utils, &scope_3_entries[0], isActive_SSM_ST_SM1_SSM_st_Bridge_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L4_Bridge_SM1, &_Type_kcg_bool_Utils, &scope_3_entries[0], isActive_SSM_ST_SM1_SSM_st_Bridge_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L6_Bridge_SM1, &_Type_kcg_bool_Utils, &scope_3_entries[0], isActive_SSM_ST_SM1_SSM_st_Bridge_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_INSTANCE, "Bridge 5", NULL, sizeof(outC_Bridge), (size_t)&outputs_ctx.Context_Bridge_5, NULL, &scope_3_entries[0], isActive_SSM_ST_SM1_SSM_st_Bridge_SM1, &scope_42, 1, 6 }
};
...
const MappingEntry scope_20_entries[5] = {
    /* 0 */ { MAP_LOCAL, "_L14", NULL, sizeof(status), offsetof(outC_Door, _L14_FullyClose_SM1), &_Type_status_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyClose_SM1, &scope_2, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L13", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L13_FullyClose_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyClose_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L12_FullyClose_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyClose_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L11_FullyClose_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyClose_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L10_FullyClose_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyClose_SM1, NULL, 1, 4 }
};
...
const MappingEntry scope_19_entries[1] = {
    /* 0 */ { MAP_STRONG_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_10_entries[5], isActive__5_SSM_TR_SM1_SSM_TR_Closing_Opening_1_Closing_SM1, NULL, 1, 0 }
};
...
const MappingEntry scope_18_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_10_entries[6], isActive__5_SSM_TR_SM1_SSM_TR_Closing_FullyClose_2_Closing_SM1, NULL, 1, 0 }
};
...
const MappingEntry scope_17_entries[13] = {
    /* 0 */ { MAP_FORK, "<2", NULL, 0, 0, NULL, &scope_10_entries[6], isActive__5_SSM_TR_SM1_SSM_TR_Closing_FullyClose_2_Closing_SM1, &scope_18, 1, 0 },
    /* 1 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_10_entries[5], isActive__5_SSM_TR_SM1_SSM_TR_Closing_Opening_1_Closing_SM1, &scope_19, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L53", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L53_Closing_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L52", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L52_Closing_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L51", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L51_Closing_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L50", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L50_Closing_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L48", NULL, sizeof(status), offsetof(outC_Door, _L48_Closing_SM1), &_Type_status_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, &scope_2, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L47", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L47_Closing_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L46", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L46_Closing_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L45", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L45_Closing_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L44", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L44_Closing_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L43", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L43_Closing_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L54", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L54_Closing_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, NULL, 1, 12 }
};
...
const MappingEntry scope_16_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_10_entries[6], isActive__5_SSM_TR_SM1_SSM_TR_Opening_FullyOpen_1_Opening_SM1, NULL, 1, 0 }
};
...
const MappingEntry scope_15_entries[12] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_10_entries[6], isActive__5_SSM_TR_SM1_SSM_TR_Opening_FullyOpen_1_Opening_SM1, &scope_16, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L4_Opening_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L5_Opening_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L6_Opening_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L7_Opening_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L9_Opening_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L11_Opening_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_int32), offsetof(outC_Door, _L12_Opening_SM1), &_Type_kcg_int32_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L25", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L25_Opening_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L24", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L24_Opening_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L23", NULL, sizeof(status), offsetof(outC_Door, _L23_Opening_SM1), &_Type_status_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, &scope_2, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L22", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L22_Opening_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, NULL, 1, 11 }
};
...
const MappingEntry scope_14_entries[5] = {
    /* 0 */ { MAP_LOCAL, "_L14", NULL, sizeof(status), offsetof(outC_Door, _L14_FullyOpen_SM1), &_Type_status_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyOpen_SM1, &scope_2, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L13", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L13_FullyOpen_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyOpen_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L12_FullyOpen_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyOpen_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L11_FullyOpen_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyOpen_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L10_FullyOpen_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyOpen_SM1, NULL, 1, 4 }
};
...
const MappingEntry scope_13_entries[1] = {
    /* 0 */ { MAP_STRONG_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_10_entries[5], isActive__5_SSM_TR_SM1_SSM_TR_ToMove_Closing_2_ToMove_SM1, NULL, 1, 0 }
};
...
const MappingEntry scope_12_entries[1] = {
    /* 0 */ { MAP_STRONG_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_10_entries[5], isActive__5_SSM_TR_SM1_SSM_TR_ToMove_Opening_1_ToMove_SM1, NULL, 1, 0 }
};
...
const MappingEntry scope_11_entries[7] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_10_entries[5], isActive__5_SSM_TR_SM1_SSM_TR_ToMove_Opening_1_ToMove_SM1, &scope_12, 1, 0 },
    /* 1 */ { MAP_FORK, "<2", NULL, 0, 0, NULL, &scope_10_entries[5], isActive__5_SSM_TR_SM1_SSM_TR_ToMove_Closing_2_ToMove_SM1, &scope_13, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L6", NULL, sizeof(status), offsetof(outC_Door, _L6_ToMove_SM1), &_Type_status_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_ToMove_SM1, &scope_2, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L7_ToMove_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_ToMove_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L11_ToMove_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_ToMove_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L12_ToMove_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_ToMove_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L13", NULL, sizeof(kcg_bool), offsetof(outC_Door, _L13_ToMove_SM1), &_Type_kcg_bool_Utils, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_ToMove_SM1, NULL, 1, 6 }
};
...
const MappingEntry scope_10_entries[12] = {
    ...
    /* 7 */ { MAP_STATE, "ToMove:", NULL, 0, 0, NULL, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_ToMove_SM1, &scope_11, 1, 7 },
    /* 8 */ { MAP_STATE, "FullyOpen:", NULL, 0, 0, NULL, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyOpen_SM1, &scope_14, 1, 8 },
    /* 9 */ { MAP_STATE, "Opening:", NULL, 0, 0, NULL, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Opening_SM1, &scope_15, 1, 9 },
    /* 10 */ { MAP_STATE, "Closing:", NULL, 0, 0, NULL, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_Closing_SM1, &scope_17, 1, 10 },
    /* 11 */ { MAP_STATE, "FullyClose:", NULL, 0, 0, NULL, &scope_10_entries[0], isActive__4_SSM_ST_SM1_SSM_st_FullyClose_SM1, &scope_20, 1, 11 }
};
