...
/* Button/ */
void Button(inC_Button *inC, outC_Button *outC)
{
  /* activated/ */
  ...
  switch (outC->Button_state_sel) {
    case SSM_st_pressed_Button :
      tr_1_guard_pressed_Button = inC->deactivate;
    ...
    case SSM_st_notPressed_Button :
      tr_1_guard_notPressed_Button = inC->clicked;
  ...
  switch (outC->Button_state_act) {
    case SSM_st_pressed_Button :
      ...
      outC->_L2_pressed_Button = inC->deactivate;
    ...
    case SSM_st_notPressed_Button :
      ...
      outC->_L3_notPressed_Button = inC->clicked;
...
void Button_init(outC_Button *outC)
{
  ...
  outC->_L1_pressed_Button = kcg_true;
  outC->_L2_pressed_Button = kcg_true;
  outC->_L2_notPressed_Button = kcg_true;
  outC->_L3_notPressed_Button = kcg_true;
